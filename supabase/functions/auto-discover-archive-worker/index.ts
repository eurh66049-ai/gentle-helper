...
serve(async (req) => {
  ...
  try {
    ...
    // ★ تفعيل وضع Mistral AI الافتراضي عندما يتوفر المفتاح:
    // يولّد عناوين كتب عربية حقيقية متنوعة كل تشغيل، ويبحث عنها في archive.org،
    // ويتجنّب التكرار مع الكتب الموجودة في الموقع/الطابور.
    const aiAuto = !!mistralKey;
    if (aiMatch || aiAuto) {
